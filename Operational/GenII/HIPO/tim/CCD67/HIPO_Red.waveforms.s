...
; For HIPO uncomment one of these lines at a time
;INT_TIM	EQU	$040000	; 0.85 us/px - use gain 9.5, experimental
INT_TIM	EQU	$080000	; 1.0 us/px - use gain 9.5, doesn't clip
; Old CCD47 ones below.
...
SI_DELAY	EQU	$020000 ; 120 ns parallel overlaps
...
VODL	EQU	20.0	; Output Drain Left
VODR	EQU	20.0	; Output Drain Right
VRDL	EQU	9.80	; Reset Drain Left. | To produce +9.0 in real life
VRDR	EQU	9.80	; Reset Drain Right | on the red side.
...
; Input offset voltages for DC coupling. Target is U4#6 = 24 volts
	DC	$0c0880			; Input offset, ch. A
	DC	$0c8880			; Input offset, ch. B
