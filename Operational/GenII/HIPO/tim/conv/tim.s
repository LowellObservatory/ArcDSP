...
NS_CLR	DC      1070 		; To clear serial register, twice
NPCLR   DC      2057    	; To clear parallel register, twice 
NSBIN   DC      1       	; Serial binning parameter
NPBIN   DC      1       	; Parallel binning parameter
NROWS	DC	1030		; Number of physical rows in CCD
NCOLS	DC	1072		; Number of physical columns in CCD
...
SH_DEL	DC	4		; Change needed to kill shift streak after DCRes
...
S_SIZE		DC	1033	; Number of rows in the Storage Array
...
; Include the waveform table
	INCLUDE "HIPO_Blue.waveforms.s" ; Readout and clocking waveforms
